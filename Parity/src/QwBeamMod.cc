...
Int_t QwBeamMod::LoadEventCuts( const TString& filename)
{
...
void  QwModChannelID::Print() const
{
...
void QwBeamMod::WritePromptSummary( QwPromptSummary *ps, const TString& datatype)
{
  return;
};
